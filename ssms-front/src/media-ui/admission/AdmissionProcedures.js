...
const key = 'admission_procedures'
const endpoint = '/abouts/25'

function Procedures({ lang, aboutTitleAr, aboutTitleEn, aboutTextAr, aboutTextEn }) {
  return (
    <>
...
function AdmissionProcedures({ lang, trans }) {
    // get AdmissionProcedures from LS OR Server
...
export default connect(mapStateToProps)(AdmissionProcedures)
